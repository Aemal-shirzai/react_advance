    ...
    return (
        <header className="navbar navbar-expand-md navbar-dark bd-navbar bg-dark">
            <nav className="container-xxl flex-wrap flex-md-nowrap" aria-label="Main navigation">
                <Link className="navbar-brand p-0 me-2" to="/" aria-label="Bootstrap">
                ...
                <ul className="navbar-nav flex-row flex-wrap bd-navbar-nav pt-2 py-md-0">
                    ...
                    <li className="nav-item col-6 col-md-auto dropdown">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><NavLink className="dropdown-item" to="/lists">Transforming Lists</NavLink></li>
                            <li><NavLink className="dropdown-item" to="/lists_key">Key Benefits</NavLink></li>
                        </ul>
                    </li>
                    <li className="nav-item col-6 col-md-auto dropdown">
                        <a className="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><NavLink className="dropdown-item" to="/forms">Simple Form</NavLink></li>
                            <li><NavLink className="dropdown-item" to="/forms/simple_file_upload">Simple File Upload</NavLink></li>
                            <li><NavLink className="dropdown-item" to="/forms/form_with_hook">React Form Hook</NavLink></li>
                        </ul>
                    </li>
                    <li className="nav-item col-6 col-md-auto dropdown">
                        <a className="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><NavLink className="dropdown-item" to="/use_memo">useMemo</NavLink></li>
                ...
                <a className="btn btn-bd-download d-lg-inline-block my-2 my-md-0 ms-md-3" href="/docs/5.0/getting-started/download/">Download</a>
                </div>
            </nav>
        </header>
    );
